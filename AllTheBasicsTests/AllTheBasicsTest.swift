...
class AllTheBasicsTest: XCTestCase {
    ...
    func testAverageIsAbove75() {
        ...
        XCTAssertFalse(testVC.averageIsAbove75(num1: 76, num2: 75, num3: 71.9), "Average is below 75, it should return false."  )
        
        XCTAssertFalse(testVC.averageIsAbove75(num1: 75, num2: 75, num3: 75), "Average must be over 75 to return true.")
        
        XCTAssertTrue(testVC.averageIsAbove75(num1: 75.1, num2: 75, num3: 75), "Avererage is above 75, should return true.")
        
        XCTAssertTrue(testVC.averageIsAbove75(num1: 80, num2: 80, num3: 80), "Average is above 75, should return true.")
